      ...
      <div className="container d-md-flex align-items-center px-0 px-xl-3">
        ...
        <div className="d-flex text-md-end ms-md-auto">
          ...
          <Dropdown className="ms-auto ms-md-0">
            ...
            >
              <img class="me-2" src={En} alt="English" width="20" />
              Eng
            </Dropdown.Toggle>
            <Dropdown.Menu className="super-colors">
              <Dropdown.Item as="button">
                <img class="me-2" src={Fr} alt="Français" width="20" />
                Français
              </Dropdown.Item>
              <Dropdown.Item as="button">
                <img class="me-2" src={De} alt="Deutsch" width="20" />
                Deutsch
              </Dropdown.Item>
              <Dropdown.Item as="button">
                <img class="me-2" src={It} alt="Italiano" width="20" />
                Italiano
              </Dropdown.Item>
            </Dropdown.Menu>
          </Dropdown>
